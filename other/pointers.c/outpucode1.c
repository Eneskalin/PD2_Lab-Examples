...
int main(){
    ...
    printf("Output 1: %d\n",*(m+1)); //1
    *(m+2)+=3; // A={"0",1,3,5,0,2,0,1,2,2} "2210205010" 2210205014 2210205018 2210205022 2210205026 2210205030 2210205034 ...
    m+=4; // A={0,1,3,"5",0,2,0,1,2,2}  2210205010 2210205014 2210205018 2210205022 "2210205026" 2210205030 2210205034 ...
    printf("Output 2:%d\n",(m+1)); // 2210205030
    m=&A[1]; // m=221020514
    k=&m; // k=111 *k=&m
    printf("Output 3: %d\n",*(*(k)+1)); // *k-> &m -> (m+1) -> 3
